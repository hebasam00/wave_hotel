...
<head>
    ...
    <style>
        body {
            ...
            background: linear-gradient(120deg, #2980b9, #936b47);
            display: flex;
...
<body>
    <div class="container">
        <div class="form-container">
            ...
            <form id="login-form" class="form active" method="POST" action="{{ route('login') }}">
                @csrf
                <h2>Login</h2>
            ...
            <form method="POST" id="signup-form" class="form" action="{{ route('register') }}">
                @csrf
                <h2>Sign Up</h2>
