    ...
    <section id="hotels" class="section">
        <div class="container">
            ...
            <div class="cards">
                <!-- Card 1 -->
                <div class="card">
                    <img src="{{ asset('img/7af23998_z.webp') }}" alt="Hotel 1">
                    <h3>Lacosta Hotel</h3>
                    <p>Experience the ultimate luxury with breathtaking views and top-notch amenities.</p>
                    <a href="{{ route('lacosta') }}" class="book-now">Book Now</a>
                </div>

                <!-- Card 2 -->
                <div class="card">
                    <img src="{{ asset('img/0ae049911b71731cb920927ac9ab65ac6d44685c.jpg') }}" alt="Hotel 2">
                    <h3>Oryx Hotel Aqaba</h3>
                    <p>Discover serenity and luxury with world-class services and stunning surroundings.</p>
                    <a href="{{ route('oryx') }}" class="book-now">Book Now</a>
                </div>
