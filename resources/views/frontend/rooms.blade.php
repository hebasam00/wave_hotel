  ...
  <section class="section">
    ...
    <div class="col-md-4" data-aos="fade-up">
        <figure class="img-wrap">
            <img src="{{ asset('frontend/images/img_1.jpg') }}" alt="Room Image" class="img-fluid mb-3">
        </figure>
        <div class="p-3 text-center room-info">
            <h2>Room Number: {{$item->room_number}}</h2>
            <span class="letter-spacing-1">Price: {{$item->price_per_night}} $</span>
            <p>
                <a href="{{ route('reservation', $item->id) }}" class="btn btn-primary text-white mt-3">Book Now</a>
            </p>
        </div>
    </div>
    @endforeach
